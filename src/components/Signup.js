                ...
                <div className="col-md-5 col-sm-12 px-5 formBox">
                    <div className="card shadow">
                        <div className="card-body px-5">
                            <h4 className="card-title text-center fw-bold my-3">Sign Up</h4>
                            <form className="mt-3">
                                <div className="mb-3">
                                    <input type="text" className="p-2 form-control input-bg mb-2" placeholder="Phone" />
                                ...
                                <div className="d-grid">
                                    <button type="submit" className="btn btn-primary rounded-1 logIn-button">Sign up</button>
                                </div>
                                <div className="my-4">
                                ...
                                <span className="ms-1 link-primary fw-bold signup-button">Sign Up</span>
                                    ...
                                    <div className="my-2 signup-text">
                                        Already have an account? <a href="/"><span>Login</span></a>
                                    </div>
                                </div>
                            </form>
                        </div>
